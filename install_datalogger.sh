...
if stel_vraag "Stap 6: Cronjobs instellen in jouw persoonlijke crontab?"; then
    ...
    echo "2,17,32,47 * * * * sudo cp ~/RaspiDagTemperatuur.png /var/www/html/RaspiDagTemperatuur.png" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp ~/RaspiWeekTemperatuur.png /var/www/html/RaspiWeekTemperatuur.png" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp ~/RaspiMaandTemperatuur.png /var/www/html/RaspiMaandTemperatuur.png" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp ~/RaspiDagVochtigheid.png /var/www/html/RaspiDagVochtigheid.png" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp ~/RaspiWeekVochtigheid.png /var/www/html/RaspiWeekVochtigheid.png" >> temp_cron
    echo "2,17,32,47 * * * * sudo cp ~/RaspiMaandVochtigheid.png /var/www/html/RaspiMaandVochtigheid.png" >> temp_cron
